/*
 PureMVC Javascript edition for Titanium by Erin Lin <erinylin@gmail.com>
 Actually this isn't only for Titanium, this is a lite version of Javascript implementation.
 90% reused from PureMVC Javascript port for Prototype by Frederic Saunier <frederic.saunier@puremvc.org> 
...
(function( global ){
/*
 * Useage: clone( superClassObj , ...args ):superClassObj
 */
var clone = function () {
	if( arguments.length < 1) throw new Error("Missing superClass!!");
	var F = function (){};
...
var Facade = {
		...
		{
			this.notifyObservers( clone( Notification, name, body, type ) );
		},
...
var Controller = {
		...
		registerCommand: function( name, commandClassRef )
		{
			if( !this.commandMap[name] )
				this.view.registerObserver( name, clone( Observer, this.executeCommand, this ) );
...
{
	if( !Controller.instance )
		Controller.instance = clone(Controller);
...
var View = {
		...
		registerMediator: function( mediator )
		{
			...
			if( len )
			{
    			...
    			var observer/*Observer*/ = clone(Observer, mediator.handleNotification, mediator );
				for( var i=0; i<len; i++ )
 ...
 * @constructor
 */
var MacroCommand = clone( Notifier );
		 ...
		 */
		MacroCommand.initializeMacroCommand = function(){};
		 ...
		 * 		A reference to the constructor of the <code>Command</code>.
		 */
		MacroCommand.addSubCommand = function( commandClassRef )
		{
		 ...
		 */
		MacroCommand.execute = function( note )
		{
			while( this.subCommands.length > 0)
			{
				var commandClassRef/*Function*/ = this.subCommands.shift();
				var commandInstance/*Command*/ = clone( commandClassRef );
 ...
 * @constructor
 */
var SimpleCommand = clone( Notifier );
		/**
		 ...
		 */
		SimpleCommand.execute = function( note ){};
/**
 * @classDescription
...
var Mediator = clone( Notifier );
		 ...
		 *
		 */
		Mediator.initialize = function( mediatorName, viewComponent )
		{
		 ...
		 * 		<code>Mediator</code>.
		 */
		Mediator.listNotificationInterests = function()
		{
			return [];
		};
		 ...
		 */
		Mediator.getMediatorName =  function()
		{
		 ...
		 * 		The view component.
		 */
		Mediator.getViewComponent = function()
		{
		 ...
		 * 		The view component.
		 */
		Mediator.setViewComponent =  function( viewComponent )
		{
			this.viewComponent = viewComponent;
		};
		 ...
		 */
		Mediator.handleNotification = function( note ){};
...
var Proxy = clone( Notifier );
		 ...
		 */
		Proxy.initialize = function( proxyName, data )
		{
